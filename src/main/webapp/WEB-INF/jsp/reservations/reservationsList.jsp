...
<body>
	...
	<div class="container">
		...
		<datatables:table id="reservations" data="${selections}"
			row="reservation" theme="bootstrap2" cssClass="table table-striped"
			pageable="false" info="false" export="xls"
			>

			<datatables:column title="预约号" property="id" cssStyle="width: 15%;" />
			<datatables:column title="姓名" property="personName"
				cssStyle="width: 15%;" />
			<datatables:column title="身份证号" property="idCardNo"
				cssStyle="width: 20%;" />
			<datatables:column title="电子邮箱" property="email"
				cssStyle="width: 20%;" />
			<datatables:column title="手机号" property="phone"
				cssStyle="width: 15%;" />
