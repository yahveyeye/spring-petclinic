...
public class ReservationController {
    ...
    public String processFindForm(Reservation reservation, BindingResult result, Map<String, Object> model) {
        ...
        if (reservation.getLastName() == null) {
            reservation.setLastName(""); // empty string signifies broadest possible search
        }

        // find reservations by last name
        Collection<Reservation> results = this.clinicService.findReservationByLastName(reservation.getLastName());
        if (results.isEmpty()) {
